...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper" style = "float:center;">
    ...
    <?php
          ...
          $med = $conn->query("SELECT * from tbl_patientpersonalrecords WHERE fld_patientID ='".$_GET['view_id']."'");
          ...
          $complaint = $conn->query("SELECT * FROM tbl_diagnosis WHERE fld_patientID ='".$_GET['view_id']."' AND fld_date = '$date_now'");
          while ($crow = mysqli_fetch_array($complaint)){
            $case = $crow[3];
            $com = $crow[4];
            $primary = $crow[5];
            $med = $crow[6];
    ...
    <form method = "POST" action = "">
      ...
      <div class="box" style = "margin-top:-50px; ">
        ...
        <div class="box-body">
          ...
          <h3><label style = "color:gray;">Case Number:</label> <?php echo $case;  ?></h3>
          <div class="row">
            <div class = "col-md-10">
              <div class="form-group">
                <label style = "color:black;">Complaint</label>
                <input type="text" class = "form-control"  name="complaint" value = "<?php echo $com; ?>" readonly>
            </div>
          ...
          <div class = "col-md-10">
              <div class="form-group">
                <label style = "color:black;">Final Diagnosis</label>
                <input type="text" class = "form-control"  name="finaldiagnosis" value = "<?php echo $primary; ?>">
            </div>

             <div class = "col-md-10">
              <div class="form-group">
                <label style = "color:black;">Medicine</label>
                <input type="text" class = "form-control"  name="med" value = "<?php echo $med; ?>">
            </div>
