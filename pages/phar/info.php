          ...
          <div class="row">
            <div class="col-md-6">
              <div class = "col-md-8">
                ...
                <label style = "color:black;">Purchase Medicine</label>
                <input type = "text" class = "form-control" id = "input" name = "medicine[]"></div></div><br>
                 <button type="button" value="add" class="btn btn-primary" id="btn"><i class="fa fa-plus"></i></button>
               </div>
             </div>
           </div>
          </div>
...
<script>
  $(function () {
    ...
    $('document').ready(function(){
      $('#btn').click(function(){
        $('#input').append('<div class="box-body"><div class="row"><div class="col-md-12"><div class = "col-md-12"><div class="form-group" id = "input"><input type = "text" class = "form-control" id = "input" name = "medicine[]"></div></div><br></div></div></div>');
      })
    })
