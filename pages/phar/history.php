    ...
    <div class="box"  >
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                $query=mysqli_query($conn,"select * from tbl_pharmacy order by fld_date asc");
                ...
                <td>
                  ...
                  <a href="view-patient.php?view_id=<?php echo $row[1]; ?>" id = "view" class="btn btn-success"><span class="fa fa-eye"></span> View Purchase</a>
