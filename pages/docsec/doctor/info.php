...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper" style = "float:center;">
    ...
    <?php
          ...
          $date_now = date('Y-m-d');
          $complaint = $conn->query("SELECT * FROM tbl_diagnosis WHERE fld_patientID ='".$_GET['id']."' AND fld_casenumber = '".$_GET['case']."'");
          while ($crow = mysqli_fetch_array($complaint)){
            $case = $crow[6];
            $com = $crow[7];
          }
        ?>
    <form method = "POST" action = "timeout.php?id=<?php echo $timeid;?>&patient=<?php echo $patientID;?>&case=<?php echo $case; ?>">
