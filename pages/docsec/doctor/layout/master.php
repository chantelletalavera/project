  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <!--<li><a href="user-index.php"><i class="fa fa-search"></i> <span>Search Patient</span></a></li>-->
       <li><a href="appointment.php"><i class="fa fa-table"></i> <span>Patient List</span></a></li>
       <li><a href="graph.php"><i class="fa fa-bar-chart"></i> <span>Graph</span></a></li>
       <li><a href="patientmanagement.php"><i class="fa fa-wheelchair"></i> <span>Patient History</span></a></li>
